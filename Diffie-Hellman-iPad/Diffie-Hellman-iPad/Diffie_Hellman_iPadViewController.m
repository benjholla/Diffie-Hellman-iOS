//
//  Diffie_Hellman_iPadViewController.m
//  Diffie-Hellman-iPad
//
...
#import "Diffie_Hellman_iPadViewController.h"

@implementation Diffie_Hellman_iPadViewController
...
@synthesize generatorLabel;
@synthesize modulusLabel;
@synthesize senderSecretInterimLabel;
@synthesize senderPublicInterimLabel;
@synthesize senderSharedSecretLabel;
@synthesize receiverSecretInterimLabel;
@synthesize receiverPublicInterimLabel;
@synthesize receiverSharedSecretLabel;
...
- (IBAction) reset:(id)sender {
    ...
    self.generatorLabel.text = @"?";
    self.modulusLabel.text = @"?";
    self.senderSecretInterimLabel.text = @"?";
    self.senderPublicInterimLabel.text = @"?";
    self.senderSharedSecretLabel.text = @"?";
    self.receiverSecretInterimLabel.text = @"?";
    self.receiverPublicInterimLabel.text = @"?";
    self.receiverSharedSecretLabel.text = @"?";
...
- (IBAction) generatePublicKeys:(id)sender {
    ...
    self.generatorLabel.text = [NSString stringWithFormat:@"%d", generatorValue];
    self.modulusLabel.text = [NSString stringWithFormat:@"%d", modulusValue];
}
...
- (IBAction) generateInterimKey:(id)sender { 
	...
	if(self.senderModeSwitch.on) {
        ...
        self.senderSecretInterimLabel.text = [NSString stringWithFormat:@"%d", senderSecretKeyValue];
        self.senderPublicInterimLabel.text = [NSString stringWithFormat:@"%d", senderPublicKeyValue];
	} else {
		if ([self.receiverKeyTextField.text length] == 0) {
        ...
        self.receiverSecretInterimLabel.text = [NSString stringWithFormat:@"%d", receiverSecretKeyValue];
        self.receiverPublicInterimLabel.text = [NSString stringWithFormat:@"%d", receiverPublicKeyValue];
	}
    [self setButtonState];
    if(self.senderModeSwitch.on){
...
- (IBAction) calculateSharedKey:(id)sender {
    ...
    self.senderSharedSecretLabel.text = [NSString stringWithFormat:@"%d", sharedSecretKeyValue];
    self.receiverSharedSecretLabel.text = [NSString stringWithFormat:@"%d", sharedSecretKeyValue];
}
